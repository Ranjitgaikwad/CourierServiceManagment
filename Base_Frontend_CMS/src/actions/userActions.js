...
export const Signup_emp = (firstName, lastName, email, password) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8080/employee/register'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const Signin_admn = (email, password) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8080/admin/authenticate'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const Signin_emp = (email, password) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8080/employee/authenticate'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const Signin_cust = (email, password) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8080/customer/authenticate'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
