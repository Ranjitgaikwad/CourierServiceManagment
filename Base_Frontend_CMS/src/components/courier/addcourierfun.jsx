...
const CourierrAddScreen = (props) => {

    //const userSignin = useSelector(store => store.userSignIn)

    const url_AddCourier = "http://localhost:8080/employee/addcourier"
            ...
            <div className="row">
                ...
                <div className="col-md-20">
                    ...
                    <div className="mb-3">
                        ...
                        <input onChange={e => {setremark(e.target.value)}} className="form-control" type="text" placeholder="Locality / area / nearby landmark " />
                    </div>
                    ...
                    <div className="mb-3">
                        <br/>
                        <button onClick={onAddCourier} className="btn btn-outline-primary"> Add address </button>
...
export default CourierrAddScreen